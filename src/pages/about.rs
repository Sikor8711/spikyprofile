...
pub fn AboutPage() -> impl IntoView {
    view! {
        ...
        <div class="space-y-5 text-neutral-300">
            ...
            <p>
                "I met Luiza. And she changed everything. Not in the dramatic, cinematic way people talk about love changing things. In the real way. She believed in things. She believed in building things. Together we opened a plant-based café in Leicester called Healthy Louisa Cafe Deli."
            </p>
            <p>
            ...
            <p>
                "At age 38, I had a cognitive assessment. A formal one. The kind where someone sits you down for hours and measures how your brain actually works. Not what you know — how you process."
            </p>
            ...
            <p>
                "The assessor called it a \"spiky profile.\" Sharp peaks and deep valleys on the same graph. Not a flat line of average. Not a smooth curve of general ability. Spikes. Jagged. Uneven. Extreme in both directions."
            </p>
            <p>
